...
namespace ET.Server
{
    ...
    public class InitServerEventHandler: AEvent<ET.EventType.InitServerEvent>
    {
        protected override async ETTask Run(Scene scene, ET.EventType.InitServerEvent args)
        {
            // 发送普通actor消息
