...
namespace ET.Common
{
    public partial class FGUIInputField1 : GComponent
    {
        ...
        public static FGUIInputField1 CreateInstance()
        {
            return (FGUIInputField1)UIPackage.CreateObject("Common", "InputField1");
        }
